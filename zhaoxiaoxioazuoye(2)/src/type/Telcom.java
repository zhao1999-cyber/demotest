...
import java.util.*;
public class Telcom extends sorts{
    private String phoneNumber;
    private String callTo;
    private StringBuffer communicationRecords;
    public Telcom(String phoneNumber) {
    	...
    	//随机生成被呼叫的号码
    	 private String getCallToPhoneNumber() {
    	    	return "1773965" + String.valueOf(new Random().nextInt(10)) + String.valueOf(new Random().nextInt(10)) + String.valueOf(new Random().nextInt(10)) + String.valueOf(new Random().nextInt(10));
    	    }
    	 //计费
